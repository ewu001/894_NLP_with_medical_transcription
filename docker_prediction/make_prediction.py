...
server_endpoint = 'http://localhost:8501/v1/models/cnn_model1:predict'
...
def run(tokenizer, dataset):

    requests_tokenized = tokenizer.texts_to_sequences(dataset)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--model_name',
        help='name of the model to be included in the API endpoint, must match what is on the docker [cnn_model1, cnn_model2, cnn_model3, lstm_model, gru_model, attention_gru_model, attention_lstm_model]',
        required=True
    )
    ...
    server_endpoint = 'http://localhost:8501/v1/models/' + model_name + ':predict'

    with open('tokenizer.pickle', 'rb') as handle:
        tokenizer = pickle.load(handle)

    request = urgent + non_urgent
    run(tokenizer, request)

# Sample command:
# python make_prediction.py --model_name=cnn_model1 
# python make_prediction.py --model_name=cnn_model2
# python make_prediction.py --model_name=cnn_model3
# python make_prediction.py --model_name=lstm_model
# python make_prediction.py --model_name=gru_model
# python make_prediction.py --model_name=attention_gru_model
# python make_prediction.py --model_name=attention_lstm_model