import argparse
import attention_estimator_factory
import tempfile
...
if __name__ == '__main__':
    ...
    attention_estimator_factory.MAX_SEQUENCE_LENGTH = hparams.pop('max_sequence_length')
    attention_estimator_factory.VOCAB_SIZE= hparams.pop('vocab_size')
    attention_estimator_factory.EMBEDDING_DIM= hparams.pop('embedding_dim')
    

    # Initialize the training and evaluation
    attention_estimator_factory.train_and_evaluate(output_dir, hparams)